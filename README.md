...
This is a sample template for mailchimp - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name mailchimp --query 'Stacks[].Outputs'
```
